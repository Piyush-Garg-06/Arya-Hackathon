...
export class Backend implements backendInterface {
    ...
    async getCareerSessions(): Promise<Array<CareerSession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCareerSessions();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async saveCareerSession(arg0: string, arg1: number, arg2: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveCareerSession(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveInterviewSession(arg0: string, arg1: bigint, arg2: string, arg3: Array<string>, arg4: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveInterviewSession(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProfile(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<string>): Promise<void> {
        if (this.processError) {
            try {
